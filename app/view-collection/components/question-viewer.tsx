...
export function QuestionViewerComponent({
  ...
  const totalQuestions = useMemo(() => activities.length, [activities]);
  ...
  const estimatedTimeRemaining = useMemo(() => {
    const remainingActivities = activities.slice(currentIndex + 1);
        ...
        try {
          ...
          map.on('load', () => {
            ...
            locationAnswers.forEach((location, index) => {
              ...
              const popup = new mapboxgl.Popup({ offset: 25 }).setHTML(`
                <div class="p-3">
                  ...
                  <div class="text-sm text-gray-600 space-y-1">
                    ...
                    <div><strong>Bán kính:</strong> ${location.radius}m</div>
                  </div>
                </div>
              `);
              ...
              // Add circle to show radius area
              ...
              map.addLayer({
                ...
                paint: {
                  'circle-radius': {
                    stops: [
                      [0, 0],
                      [20, location.radius / 10], // Adjust radius based on zoom
                    ],
                    base: 2,
                  },
                  'circle-color': '#3b82f6',
  ...
  const MatchingPairsComponent = ({ activity }: { activity: Activity }) => {
    ...
    return (
      <div className='w-full bg-gray-50 dark:bg-gray-800 min-h-[500px]'>
        ...
        <div
          ref={containerRef}
          className='matching-pair-preview relative p-8 bg-gray-50 dark:bg-gray-800'
        ...
        >
          <div className='flex justify-between items-start gap-12 max-w-6xl mx-auto'>
            ...
            <div className='w-1/2 flex flex-col items-center gap-6'>
              <h3 className='font-bold text-xl text-center text-gray-700 dark:text-gray-300 bg-white dark:bg-gray-700 px-4 py-2 rounded-lg shadow-sm'>
                {leftColumnName}
              </h3>
  ...
  const renderSlideContent = (activity: Activity) => {
    ...
    const slideIndex =
      activities.findIndex((a) => a.activityId === activity.activityId) + 1;
      ...
      >
        <div className='flex flex-col items-center gap-3 w-full px-4 pb-8 pt-4 bg-gradient-to-br from-indigo-100/90 via-purple-100/80 to-blue-100/90 dark:from-indigo-900/90 dark:via-purple-900/80 dark:to-blue-900/95 min-h-[400px]'>
          ...
          <div className='flex-1 w-full flex items-center justify-center'>
            <div
              className={cn(
                'w-full max-w-4xl bg-white dark:bg-gray-800 rounded-lg shadow-xl border border-gray-200 dark:border-gray-700 overflow-hidden',
                viewMode === 'mobile' && 'max-w-sm',
            ...
            >
              {activity.backgroundImage ? (
                ...
                >
                  <div className='bg-black/50 backdrop-blur-sm rounded-lg p-6 max-w-2xl mx-4'>
          ...
          <div className='relative space-y-2'>
            ...
            {options
              ...
              .map((option, index) => (
                ...
                >
                  <div className='flex items-center gap-3 p-3 bg-white dark:bg-gray-800 rounded-lg border border-gray-200 dark:border-gray-700 shadow-sm hover:shadow-md transition-all duration-200 flex-1 relative z-10'>
                    <div className='w-8 h-8 rounded-full bg-gray-600 dark:bg-gray-400 text-white dark:text-gray-900 flex items-center justify-center text-sm font-bold shadow-sm'>
                      {index + 1}
                    </div>
  ...
  function renderQuestionContent(
    ...
    // Get background from activity data
      ...
      return (
        ...
        >
          <div className='flex flex-col items-center gap-3 w-full px-4 pb-8 pt-4 bg-gradient-to-br from-indigo-100/90 via-purple-100/80 to-blue-100/90 dark:from-indigo-900/90 dark:via-purple-900/80 dark:to-blue-900/95 min-h-[400px]'>
            ...
            <div className='flex-1 w-full'>{renderSlideContent(activity)}</div>
          </div>
        </div>
      );
    }
  ...
  return (
    <TooltipProvider>
      <div
        className={cn(
          'flex h-screen bg-gradient-to-br from-gray-50 to-gray-100 dark:from-gray-900 dark:to-gray-950',
          ...
          >
            <div className='flex items-center justify-between px-6 py-3'>
              ...
              <div className='absolute left-1/2 transform -translate-x-1/2'>
                <h1 className='text-lg font-semibold text-gray-800 dark:text-gray-200 truncate max-w-64'>
                  {collectionTitle}
                </h1>
              </div>
        ...
        <AnimatePresence>
          {!isQuestionListCollapsed && (
            <motion.div
              ...
              className='w-80 bg-white/95 dark:bg-gray-800/95 backdrop-blur-md border-r border-gray-200 dark:border-gray-700 flex flex-col'
                      ...
                      return (
                        ...
                        >
                          <div className='flex items-center gap-3'>
                            <div
                              className={cn(
                                'w-10 h-10 rounded-full flex items-center justify-center text-white text-sm font-bold shadow-md bg-gradient-to-br',
                                getQuestionTypeColor(questionType)
                              )}
                            >
                              {index + 1}
                            ...
                            <div className='flex-1 min-w-0'>
                              ...
                              {activity.quiz?.timeLimitSeconds && (
                                <div className='flex items-center gap-1 text-xs text-gray-500 dark:text-gray-400'>
                                  ...
                                  <span>
                                    {formatTime(activity.quiz.timeLimitSeconds)}
                                  </span>
                                </div>
                              )}
                            </div>
