  ...
  return (
    <div className="flex flex-col md:flex-row gap-4 mb-10">
      ...
      >
        ...
        <div className="lg:w-7/12 lg:mr-8 lg:py-8 flex flex-col justify-center items-center w-full h-full">
          <div className="flex flex-col items-center mb-6">
            <h2 className="md:text-4xl lg:text-3xl xl:text-4xl 2xl:text-5xl md:pb-0 mb-2 text-3xl font-black leading-tight text-center text-white tracking-wider">
              {t('collections.joinSession')}
            </h2>
            <h3 className="md:text-base lg:text-lg flex flex-col items-center justify-center pb-2 text-sm font-bold leading-tight text-center text-white tracking-wider space-y-1">
